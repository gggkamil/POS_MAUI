...
namespace CashierApp
{
    public partial class AdminPage : ContentPage
    {
        ...
        private async void OnAddProductClicked(object sender, EventArgs e)
        {
            ...
            // Validate inputs
            if (string.IsNullOrEmpty(name) || string.IsNullOrEmpty(category) || string.IsNullOrEmpty(quantityType) || string.IsNullOrEmpty(imagePath))
            {
        ...
        private void ClearInputFields()
        {
            ...
            QuantityTypePicker.SelectedItem = null; // Clear the selected item in the Picker
        }
    }
}
